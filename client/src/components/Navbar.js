...
const Navbar = ({ setShowModel }) => {
	...
	const renderNavButtons = () => {
		...
		if (Object.keys(user).length === 0) {
			return [
				<li className="navbar-items-list-item" onClick={closeNavbar} key="home">
					<a href="#header">Home</a>
				</li>,
				<li className="navbar-items-list-item" onClick={closeNavbar} key="about">
					<a href="#about">About</a>
				</li>,
				<li className="navbar-items-list-item" onClick={closeNavbar} key="pricing">
		...
		return [
			<li className="navbar-items-list-item" onClick={closeNavbar} key="Dashboard">
				<Link to="/surveys">Dashboard</Link>
			</li>,
			<li className="navbar-items-list-item" onClick={closeNavbar} key="credit">
	...
	return (
		<nav className="navbar">
			...
			<div className="navbar-items">
				<ul className={`navbar-items-list ${navOpen ? 'open' : ''}`}>{renderNavButtons()}</ul>
			</div>
		</nav>
	);
};
